...
4. Install dependencies: `sudo apt install cmake xorg-dev` (For non X11 on Unix users, check out [this guide](https://www.glfw.org/docs/latest/compile_guide.html) for more details).
5. Give permission to the build script: `chmod +x build.sh`
6. Build and run the program `./build.sh -r`.
